...
open class JCVScroll {
    ...
    public static var fadeColor: UIColor = .clear
    public static var fadeColors: [UIColor]?
    ...
    public static func setup(for views: [UIView], scrollView: UIScrollView, viewConstraints: [NSLayoutConstraint]) {
        ...
        if let colorList = fadeColors, colorList.count == views.count {
            fadeColor = colorList[index]
        }
